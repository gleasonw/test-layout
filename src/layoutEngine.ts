...
export function getPositionedShapes(
  ...
  const result = getPositionedShapesWithWarnings(shapes, containerBox, containerCss, childCss);
  
  // Log warnings to console
  result.warnings.forEach(warning => console.warn('[Layout Engine]', warning));
...
export function getPositionedShapesWithWarnings(
  ...
  const positionedShapes: PositionedShape[] = elements.map(({ element, shape }) => {
...
export const flexPresets = {
  wrappedRow: {
    container: 'display: flex; flex-direction: row; flex-wrap: wrap; gap: 10px;',
    child: '',
  },
  overlappingRow: {
    container: 'display: flex; flex-direction: row; flex-wrap: wrap; padding-left: 20px;',
  ...
  centeredRow: {
    container: 'display: flex; flex-direction: row; justify-content: center; align-items: center; gap: 10px;',
    child: '',
  },
  centeredColumn: {
    container: 'display: flex; flex-direction: column; justify-content: center; align-items: center; gap: 10px;',
    child: '',
  },
  spaceBetween: {
  ...
  wrappedColumn: {
    container: 'display: flex; flex-direction: column; flex-wrap: wrap; gap: 10px;',
    child: '',
  },
};
